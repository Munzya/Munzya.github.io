...
After many months using WordPress I finally made the switch to GitHub Pages. My switch largely centered around this rant that played itself out quite frequently in my head: 
